...
class Game:
    ...
    def show_game_over_screen(self):
        game_over_screen = GameOver(self.screen, self.player_bullet_count, self.enemy_bullet_count, self.enemies_killed)
        game_over_screen.draw()

    def show_victory_screen(self):
        victory_screen = VictoryScreen(self.screen, self.player_bullet_count, self.enemy_bullet_count, self.enemies_killed)
        victory_screen.draw()